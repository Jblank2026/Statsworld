      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mt-2">
                Master the power of standardization! Learn to transform any normal distribution into the standard normal distribution.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-yellow-700 mb-2">The Standardization Superpower</h3>
                  <p className="text-yellow-600">
                    Z-scores transform any normal distribution into the standard normal distribution (mean = 0, SD = 1). 
                    This lets you compare values from completely different contexts using the same scale!
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-6">
            ...
            {/* Scenarios */}
            <div className="space-y-4">
              <h4 className="font-semibold text-gray-700">Example Z-Score Scenarios:</h4>
        ...
        {/* Key Concepts */}
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-[#58595b] mb-6">🔑 Key Z-Score Concepts</h2>
          
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="font-bold text-blue-700 mb-3">🎯 What Z-Scores Do</h3>
                <ul className="text-blue-600 text-sm space-y-2">
                  <li>• Transform any normal distribution to standard normal</li>
                  <li>• Allow comparison across different scales</li>
                  <li>• Indicate how unusual a value is</li>
                  <li>• Enable use of standard normal tables</li>
                </ul>
              </div>

              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                <h3 className="font-bold text-green-700 mb-3">📏 Interpretation Rules</h3>
                <ul className="text-green-600 text-sm space-y-2">
                  <li>• Z = 0: Exactly at the mean</li>
                  <li>• Z = +1: One SD above mean (84th percentile)</li>
                  <li>• Z = -1: One SD below mean (16th percentile)</li>
                  <li>• |Z| > 2: Unusual value (less than 5% of data)</li>
                </ul>
              </div>
            </div>

            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <h3 className="font-bold text-yellow-700 mb-3">💼 Professional Applications</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-yellow-600 text-sm">
                <div>
                  <strong>Quality Control:</strong> Flag products beyond ±2 or ±3 standard deviations
                </div>
                <div>
                  <strong>Medical Screening:</strong> Identify abnormal test results requiring follow-up
                </div>
                <div>
                  <strong>Educational Assessment:</strong> Compare student performance across different tests
                </div>
                <div>
                  <strong>Performance Evaluation:</strong> Standardize ratings across different managers
                </div>
              </div>
            </div>
          </div>
